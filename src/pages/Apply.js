        ...
        <div className = "body-apply">
            <div className="containner-apply">
                ...
                {/* <!-- content-top --> */}
                    ...
                    {/* <!-- menu-com --> */}
                    <div className="menu1">
                        <button className="menu" onclick={none}><b>About</b> </button>
                        <button className="menu" onclick={none}><b>Jobs</b> </button>
                        <button className="menu" onclick={none}><b>News</b> </button>
                    </div>
                    {/* <!-- list-item-menu --> */}
                    {/* <!-- item1 --> */}
